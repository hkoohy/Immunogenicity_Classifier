---
title: "Benchmark_GBM_data using HLA specific"
author: "P Buckley"
date: "03/06/2020"
...
```
## Import the HLA specific allele dataset 

```{r}
TrainingData = readRDS("../Analysis_HLA_specific_Pathogenic/A201_standardData_forAnalysis_BALANCED.rds")
...
```{r}
combinedData=readRDS(file="HLA_Specific_GBM_combinedData.rds")
 # write.table(combinedData,"GBM_HLASpecific_combinedData.txt",sep="\t",row.names = F,quote=F)

 
```

## Accuracy 
```{r OTBACCURACY,fig.width=8,fig.height=6,message=FALSE,warning=FALSE,fig.cap="Barplot illustrating the accuracy of each model after training models as they come out the box."}
...
```{r OTBAUC,fig.width=8,fig.height=6,message=FALSE,warning=FALSE,dev='svg'}
...
```{r CVF1Score,fig.width=8,fig.height=6,message=FALSE,warning=FALSE,fig.cap="Barplot illustrating the F1 Score of each model ."}
...
```{r CVPrecisionScore,fig.width=8,fig.height=6,message=FALSE,warning=FALSE,fig.cap="Barplot illustrating the Precision of each model after performing 10-fold cross validation against the IEDB Gold Standard test dataset."}
