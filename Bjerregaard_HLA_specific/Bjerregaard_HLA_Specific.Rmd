---
title: "Bjerregaard HLA Specific"
author: "P Buckley"
date: "03/06/2020"
...
```{r}
combinedData=readRDS(file="HLASpecific_Bjerregaard_combinedData.rds")
  # write.table(combinedData,"HLASpecific_Bjerregaard_combinedData.txt",sep="\t",row.names = F,quote=F)
...
```{r,cache=T,fig.cap="Area under the precision-recall curve for a distribution of PR-AUC values after randomising the true classification. Dashed line shows PR-AUC of the predictions made during the benchmarking experiment.",fig.width=6,fig.height=6,dev='svg'}
...
```{r ,dev='svg', message=FALSE,warning=FALSE,fig.width=6,fig.height=6,fig.cap="NETTEPI_netMHCpan4 Confusion Matrix. Color is relative to sensitivity/specificity by proportional outcomes within reference groups"}
